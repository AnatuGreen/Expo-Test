        ...
        <View style={styles.container}>
          <CollapsibleView title="Basic Usage">
            ...
            <CollapsibleView title={"Initially Expanded"} initExpanded>
              <Text>
                I am opened by default because of initExpanded property set to
                true
              </Text>
            </CollapsibleView>
            ...
            <CollapsibleView title="unmountOnCollapse" unmountOnCollapse>
              <Text>
                this collapsible will unmount when collapse animation will end.
                can be very usefull when rendering a lot of exepnsive
          ...
          <CollapsibleView title="Custom Usage">
            <CollapsibleView
              title={
                <Text
                  style={{ color: "red", fontSize: 36, fontStyle: "italic" }}
                >
                  Custom Styling
                </Text>
              }
            ...
            >
              <Text>
                this collapsible is controlled by parent and his state his
                managed by him.
              </Text>
